...
import { ArrowLeft, Save, Eye, Upload, Tag, X, Zap, Brain, Cpu } from 'lucide-react';
...
export default function CreatePost() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center glass-morph-dark border border-red-400/30 p-8 rounded-2xl relative z-10 max-w-md w-full mx-4">
          ...
          <p className="text-gray-400 mb-8 tracking-wide">Neural link required to access content creation protocols.</p>
          <Link
            to="/login"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast('success', `Neural data ${formData.published ? 'transmitted to network' : 'stored in local cache'} successfully!`);
      navigate(`/post/${newPost.id}`);
    } catch (error) {
      showToast('error', 'Data transmission failed. Network error detected.');
    }
  };
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      showToast('error', 'Local cache storage failed. Please retry.');
    }
  };
  ...
  return (
    <div className="min-h-screen py-8 px-4 relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 border border-purple-400/20 animate-spin" style={{animationDuration: '15s'}}></div>
        ...
        <div className="glass-morph-dark border border-cyan-400/30 rounded-2xl p-6 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link
                to="/my-posts"
                className="cyber-button-ghost p-2 hover:bg-cyan-400/10"
              >
                <ArrowLeft size={20} />
              </Link>
              <div>
                <h1 className="text-2xl font-bold holographic tracking-wider">NEURAL CONTENT CREATION</h1>
                <p className="text-gray-400 tracking-wide">Transmit your thoughts to the collective</p>
              </div>
            </div>
        ...
        {!isPreview ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="glass-morph-dark border border-cyan-400/30 rounded-2xl p-6">
                  ...
                  <input
                    ...
                    placeholder="Enter thought transmission title..."
                  />
                  {errors.title && (
                ...
                <div className="glass-morph-dark border border-purple-400/30 rounded-2xl p-6">
                  ...
                  <textarea
                    ...
                    placeholder="Begin neural data transmission..."
                  />
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <span className="text-xs text-gray-500 font-mono ml-auto">
                      {formData.content.length} characters transmitted
                    </span>
                  </div>
                </div>
                ...
                <div className="glass-morph-dark border border-pink-400/30 rounded-2xl p-6">
                  ...
                  <textarea
                    ...
                    placeholder="Brief neural summary for network preview..."
                  />
                  {errors.excerpt && (
                    <p className="mt-2 text-sm text-red-400 flex items-center gap-1 font-mono">
                      <span className="w-4 h-4 rounded-full bg-red-400/20 flex items-center justify-center text-xs border border-red-400/30">!</span>
            ...
            <div className="space-y-6">
              {/* Publish Controls */}
              <div className="glass-morph-dark border border-cyan-400/30 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-cyber mb-4 tracking-wide">TRANSMISSION CONTROLS</h3>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    >
                      ...
                      <span className="tracking-wide">
                        {loading ? 'TRANSMITTING...' : formData.published ? 'TRANSMIT TO NETWORK' : 'STORE IN CACHE'}
                      </span>
                    </button>
                    ...
                    >
                      <Save size={18} />
                      <span className="tracking-wide">SAVE TO LOCAL CACHE</span>
                    </button>
                  </div>
                </div>
              </div>
              ...
              {/* Image Upload */}
              <div className="glass-morph-dark border border-purple-400/30 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-cyber mb-4 tracking-wide">VISUAL DATA ATTACHMENT</h3>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <Upload size={18} />
                    <span className="tracking-wide">UPLOAD VISUAL DATA</span>
                  </button>
                </div>
              </div>
